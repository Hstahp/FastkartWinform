    ...
    public partial class frmScanQR : Form
    {
        ...
        private void LoadVideoDevices()
        {
            try
            {
                ...
                {
                    MessageBox.Show("No camera was found on this computer.",
                        "No Camera",
        ...
        private void StartCamera()
        {
            try
            {
                ...
                txtResult.Clear();
                txtResult.Text = "Scanning in progress... Please hold the QR code in front of the camera.";
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Error when starting the camera: {ex.Message}",
                    "Error",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
            }
